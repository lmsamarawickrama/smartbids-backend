package org.saliam.smartbids.commons.security.filter;
...
public class AuthenticationJWTFilter extends OncePerRequestFilter
{
      ...
      throws ServletException, IOException
  {
    ...
    if (jwt != null && jwtUtilityService.validateJwtToken(jwt))
    {
      String username = jwtUtilityService.getUserNameFromJwtToken(jwt);
